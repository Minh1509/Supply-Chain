...
public class InvoiceService {
  ...
  public InvoiceDto getInvoiceBySoId(Long soId) {
  ...
  public List<InvoiceDto> getAllInvoicesByCompany(Long companyId) {
    return invoiceRepository.findBySalesCompanyId(companyId)
        .stream()
