    ...
    public Object handleEvents(BusinessEvent event) {
        try {
            ...
            return switch (event.getPattern()) {
                ...
                case "invoice.get_by_id" -> invoiceHandler.handleGetById(event.getData());
                case "invoice.get_by_so_id" -> invoiceHandler.handleGetBySoId(event.getData());
                case "invoice.get_all_in_company" -> invoiceHandler.handleGetAllInCompany(event.getData());
